...
//   //API_BASE_URL + `/orders/${guideId}` + API_KEY_PARAMS
//   fetch('https://jsonplaceholder.typicode.com/posts/1', {
//     method: 'PUT',
//     body: JSON.stringify({
//       date: DateRef.value,
//       duration: parseInt(ChoiceRef.options[ChoiceRef.selectedIndex].value),
//       guid_id: currentGuid.id,
//       price: totalSumCount,
//       optionFirst: optionRef.checked,
//       persons: countOfMembers,
...
// });
  ...
  formData.append('optionFirst', optionRef.checked);
  formData.append('optionSecond', optionRef.checked);
